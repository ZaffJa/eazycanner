...
elseif( is_shop() || is_product_category() || is_product_tag() ) {
	...
	$page_title_args = array(
		...
		'image'    	=> get_option( 'roneous_shop_header_image' ) ? '<img src="'. get_option( 'roneous_shop_header_image' ) .'" alt="'.esc_html__( 'page-header', 'roneous' ).'" class="background-image" />' : false
	); 
	echo roneous_get_the_page_title( $page_title_args );
