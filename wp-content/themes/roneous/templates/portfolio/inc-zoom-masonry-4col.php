<div class="col-md-3 col-sm-6 masonry-item masonry-item project box-zoom" data-filter="<?php echo esc_html__( 'All', 'roneous' ).','.roneous_the_terms( 'portfolio_category', ',', 'name' ); ?>" 
